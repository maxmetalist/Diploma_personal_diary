...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--email", type=str, help="Email для отправки тестового письма", default="test@example.com"
        )
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f"✅ Тестовое письмо отправлено на {test_email}!"))
            ...
            self.stdout.write(self.style.WARNING("💡 Совет: Проверьте настройки EMAIL_* в settings.py"))
