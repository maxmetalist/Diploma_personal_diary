    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.weekly_days:
            for day in self.instance.weekly_days:
                field_name = ['monday', 'tuesday', 'wednesday', 'thursday',
                              'friday', 'saturday', 'sunday'][int(day)]
        ...
        if self.instance and self.instance.monthly_days:
            self.fields['monthly_days_field'].initial = [
                str(day) for day in self.instance.monthly_days
            ]
