...
class ProfileEditForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "country": forms.TextInput(attrs={"class": "form-control", "placeholder": "Страна проживания"}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["email"] = forms.EmailField(
            widget=forms.EmailInput(attrs={"class": "form-control", "readonly": True}), required=True
        )
